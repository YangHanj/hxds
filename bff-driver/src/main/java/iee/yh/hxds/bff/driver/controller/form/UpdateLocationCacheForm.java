...
public class UpdateLocationCacheForm {
    ...
    public String getOrientateLongitude() {
        return orientateLongitude;
    }

    public void setOrientateLongitude(String orientateLongitude) {
        this.orientateLongitude = orientateLongitude;
    }

    public String getOrientateLatitude() {
        return orientateLatitude;
    }

    public void setOrientateLatitude(String orientateLatitude) {
        this.orientateLatitude = orientateLatitude;
    }
}
